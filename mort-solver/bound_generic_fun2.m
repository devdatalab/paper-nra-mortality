...
% WARNING: THIS SEEMS TO HAVE MORTALITY-SPECIFIC CHARACTERISTICS (search for mort)
...
function [bounds, min_seed, max_seed] = bound_generic_fun2(input_csv, cuts, vals, fun, f2_limit, spec, min_seed, max_seed);
    ...
    [options, num_ps, A_moments, b_moments, A_ineq, b_ineq, x0_start, lb, ub] = get_mort_solver_params2(f2_limit, spec, input_csv, cuts, vals);
