...
function [bounds, min_seed, max_seed, foom] = bound_generic_fun_nomon_seed(input_csv, f2_limit, fun, min_seed, max_seed);
    global f_min_mse
    ...
    [options, cuts, vals, num_ps, A_moments, b_moments, A_ineq, b_ineq, x0_start, lb, ub] = get_mort_solver_params_nomon(input_csv, f2_limit);
