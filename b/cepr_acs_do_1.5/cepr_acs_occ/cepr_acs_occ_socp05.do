...
Desc:	Creates consistent SOC occupation code variable for 2005.
...
replace socp05="111099" if socp05=="1110XX"
replace socp05="131199" if socp05=="1311XX"
replace socp05="151099" if socp05=="1510XX"
replace socp05="152099" if socp05=="1520XX"
replace socp05="172099" if socp05=="1720XX"
replace socp05="172199" if socp05=="1721XX"
replace socp05="172188" if socp05=="1721YY"
replace socp05="193099" if socp05=="1930XX"
replace socp05="194099" if socp05=="1940XX"
replace socp05="259099" if socp05=="2590XX"
replace socp05="274099" if socp05=="2740XX"
replace socp05="319099" if socp05=="31909X"
replace socp05="333099" if socp05=="3330XX"
replace socp05="339099" if socp05=="33909X"
replace socp05="359099" if socp05=="3590XX"
replace socp05="372019" if socp05=="37201X"
replace socp05="434999" if socp05=="434XXX"
replace socp05="439999" if socp05=="439XXX"
replace socp05="452099" if socp05=="4520XX"
replace socp05="472079" if socp05=="47207X"
replace socp05="474099" if socp05=="4740XX"
replace socp05="475099" if socp05=="4750XX"
replace socp05="475088" if socp05=="4750YY"
replace socp05="492099" if socp05=="49209X"
replace socp05="499049" if socp05=="49904X"
replace socp05="499099" if socp05=="49909X"
replace socp05="514999" if socp05=="514XXX"
replace socp05="516069" if socp05=="51606X"
replace socp05="516099" if socp05=="51609X"
replace socp05="517099" if socp05=="5170XX"
replace socp05="519199" if socp05=="5191XX"
replace socp05="534099" if socp05=="5340XX"
replace socp05="535099" if socp05=="5350XX"
replace socp05="536099" if socp05=="5360XX"
replace socp05="537099" if socp05=="5370XX"
replace socp05="537199" if socp05=="5371XX"


destring socp05, replace /* so that we can attach value labels */
...
119190 "MGR-MISC MANAGERS, INCL POSTMASTERS AND MAIL SUPERINTENDENTS" /* correction, was 119199 */
...
131199 "1311XX:BUS-OTHER BUSINESS OPERATIONS SPECIALISTS" /* CORRECTION, WAS 131999 */
...
231011 "LGL-LAWYERS AND JUDGES, MAGISTRATES, AND OTHER JUDICIAL WORKERS" /* CORRECTION, USED TO BE 231099 */
...
;
#delimit cr
lab val socp05 socp05
lab var socp05 "SOC Occupation Code"
notes socp05: X changed to 9, Y changed to 8
notes socp05: ACS: SOCP
notes socp05: Available 2005 only
}
