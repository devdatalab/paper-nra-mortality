...
Desc:	Creates consistent SOC occupation code variable for 2006-2009.
...
if `year'==2005 | (2010<=`year' & `year'<=2018) {
gen byte socp06=.
}

if 2006<=`year' & `year'<=2009 {

rename socp socp06

replace socp06="111099" if socp06=="1110XX"
replace socp06="119199" if socp06=="1191XX"
replace socp06="131999" if socp06=="131XXX"
replace socp06="151099" if socp06=="1510XX"
replace socp06="152099" if socp06=="1520XX"
replace socp06="172099" if socp06=="1720XX"
replace socp06="172199" if socp06=="1721XX"
replace socp06="172188" if socp06=="1721YY"
replace socp06="193099" if socp06=="1930XX"
replace socp06="194099" if socp06=="1940XX"
replace socp06="231099" if socp06=="2310XX"
replace socp06="259099" if socp06=="2590XX"
replace socp06="274099" if socp06=="2740XX"
replace socp06="319099" if socp06=="31909X"
replace socp06="333099" if socp06=="3330XX"
replace socp06="339099" if socp06=="33909X"
replace socp06="359099" if socp06=="3590XX"
replace socp06="372019" if socp06=="37201X"
replace socp06="434999" if socp06=="434XXX"
replace socp06="439999" if socp06=="439XXX"
replace socp06="452099" if socp06=="4520XX"
replace socp06="472079" if socp06=="47207X"
replace socp06="474099" if socp06=="4740XX"
replace socp06="475099" if socp06=="4750XX"
replace socp06="475088" if socp06=="4750YY"
replace socp06="492099" if socp06=="49209X"
replace socp06="499049" if socp06=="49904X"
replace socp06="499099" if socp06=="49909X"
replace socp06="514999" if socp06=="514XXX"
replace socp06="516069" if socp06=="51606X"
replace socp06="516099" if socp06=="51609X"
replace socp06="517099" if socp06=="5170XX"
replace socp06="519199" if socp06=="5191XX"
replace socp06="534099" if socp06=="5340XX"
replace socp06="535099" if socp06=="5350XX"
replace socp06="536099" if socp06=="5360XX"
replace socp06="537099" if socp06=="5370XX"
replace socp06="537199" if socp06=="5371XX"


destring socp06, replace /* so that we can attach value labels */
...
119199 "1191XX:MGR-MISC MANAGERS, INCL POSTMASTERS AND MAIL SUPERINTENDENTS" /* CHANGED */
...
131999 "131XXX:BUS-OTHER BUSINESS OPERATIONS SPECIALISTS" /* CHANGED */
...
151099 "1510XX:CMM-COMPUTER SCIENTISTS AND SYSTEMS ANALYSTS"
...
193099 "1930XX:SCI-MISC SOCIAL SCIENTISTS, INCL SOCIOLOGISTS"
...
194099 "1940XX:SCI-MISC LIFE, PHYSICAL, AND SOCIAL SCIENCE TECHNICIANS, INCL SOCIAL SCIENCE RESEARCH ASSISTANTS AND NUCLEAR TECHNICIANS"
211010 "CMS-COUNSELORS"
211020 "CMS-SOCIAL WORKERS"
211090 "CMS-MISC COMMUNITY AND SOCIAL SERVICE SPECIALISTS"
212011 "CMS-CLERGY"
212021 "CMS-DIRECTORS, RELIGIOUS ACTIVITIES AND EDUCATION"
212099 "CMS-RELIGIOUS WORKERS, ALL OTHER"
231099 "2310XX:LGL-LAWYERS AND JUDGES, MAGISTRATES, AND OTHER JUDICIAL WORKERS" /* CHANGED */
...
319099 "31909X:HLS-MEDICAL ASSISTANTS AND OTHER HEALTHCARE SUPPORT OCCUPATIONS, EXCEPT DENTAL ASSISTANTS"
...
339099 "33909X:PRT-LIFEGUARDS AND OTHER PROTECTIVE SERVICE WORKERS"
...
474099 "4740XX:CON-MISC CONSTRUCTION WORKERS, INCL. SEPTIC TANK SERVICERS AND SEWER PIPE CLEANERS"
...
499099 "49909X:RPR-OTHER INSTALLATION, MAINTENANCE, AND REPAIR WORKERS, INCL COMMERCIAL DIVERS, AND SIGNAL AND TRACK SWITCH REPAIRERS"
...
514999 "514XXX:PRD-MISC METAL WORKERS AND PLASTIC WORKERS, INCL MILLING AND PLANING MACHINE SETTERS, AND MULTIPLE MACHINE TOOL SETTERS, AND LAY-OUT WORKERS"
...
519199 "5191XX:PRD-OTHER PRODUCTION WORKERS, INCL SEMICONDUCTOR PROCESSORS AND COOLING AND FREEZING EQUIPMENT OPERATORS"
...
537199 "5371XX:TRN-MISC MATERIAL MOVING WORKERS, INCL SHUTTLE CAR OPERATORS, AND TANK CAR, TRUCK, AND SHIP LOADERS"
...
;
#delimit cr
lab val socp06 socp06
lab var socp06 "SOC Occupation Code"
notes socp06: ACS: SOCP
notes socp06: Consistent for 2006-2009
notes socp06: X changed to 9, Y changed to 8
}
