...
Desc:	Creates consistent ancestry variables for 2008-2011.
...
/* Ancestry, 1st entry, 2008-2011 */

if (2008<=`year' & `year'<=2011) {
replace anc1p08=anc1p if anc1p~=.
}
#delimit;
lab def anc1p08
1 "Alsatian"
...
;
#delimit cr
lab var anc1p08 "Ancestry detailed-1st entry"
lab val anc1p08 anc1p08
notes anc1p08: Consistent for 2008-2011
notes anc1p08: ACS: ANC1P


/* Ancestry, 2nd entry, 2008-2011 */

if (2008<=`year' & `year'<=2011) {
replace anc2p08=anc2p if anc2p~=.
}
#delimit;
lab def anc2p08
1 "Alsatian"
...
;
#delimit cr
lab var anc2p08 "Ancestry detailed-2nd entry"
lab val anc2p08 anc2p08
notes anc2p08: Consistent for 2008-2011
notes anc2p08: ACS: ANC2P
