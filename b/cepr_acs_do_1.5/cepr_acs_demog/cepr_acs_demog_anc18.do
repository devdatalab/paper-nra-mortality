...
/*
File:	cepr_acs_anc18.do
Date:   Apr 16, 2020, CEPR ACS Version 1.5
Desc:	Creates consistent ancestry variables for 2018.
...
/* Ancestry, 1st entry, 2018 */

if `year'==2018 {
replace anc1p=. if anc1p<0
replace anc1p=. if anc1p>999
replace anc1p18=anc1p if anc1p~=.
}
#delimit;
lab def anc1p18
0 "Suppressed for data year 2018 for select PUMAs"
1 "Alsatian"
3 "Austrian"
5 "Basque"
8 "Belgian"
...
;
#delimit cr
lab var anc1p18 "Ancestry detailed-1st entry"
lab val anc1p18 anc1p18
notes anc1p18: Consistent for 2018
notes anc1p18: ACS: ANC1P

/* Ancestry, 2nd entry, 2018 */

if `year'==2018 {
replace anc2p=. if anc2p<0
replace anc2p=. if anc2p>999
replace anc2p18=anc2p if anc2p~=.
}
#delimit;
lab def anc2p18
0 "Suppressed for data year 2018 for select PUMAs"
...
;
#delimit cr
lab var anc2p18 "Ancestry detailed-2nd entry"
lab val anc2p18 anc2p18
notes anc2p18: Consistent for 2018
notes anc2p18: ACS: ANC2P
