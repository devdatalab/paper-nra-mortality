...
Desc:	Creates consistent ancestry variables for 2012-2016.
...
;
#delimit cr
lab var anc1p12 "Ancestry detailed-1st entry"
lab val anc1p12 anc1p12
notes anc1p12: Consistent for 2012-2016
notes anc1p12: ACS: ANC1P

/*Ancestry, 2nd entry, 2012-2016 */

if 2012<=`year' & `year'<=2016 {
replace anc2p=. if anc2p<1
replace anc2p=. if anc2p>999
replace anc2p12=anc2p if anc2p~=.
}
#delimit;
lab def anc2p12
1 "Alsatian"
...
;
#delimit cr
lab var anc2p12 "Ancestry detailed-2nd entry"
lab val anc2p12 anc2p12
notes anc2p12: Consistent for 2012-2016
notes anc2p12: ACS: ANC2P
