...
Desc:	Creates consistent ancestry variables for 2005-2007.
...
/* Ancestry, 1st entry, 2005-2007 */

if 2005<=`year' & `year'<=2007 {
replace anc1p05=anc1p if anc1p~=.
}
#delimit;
lab def anc1p05
1 "Alsatian"
...
;
#delimit cr
lab var anc1p05 "Ancestry detailed-1st entry"
lab val anc1p05 anc1p05
notes anc1p05: Consistent for 2005-2007
notes anc1p05: ACS: ANC1P

/* Ancestry, 2nd entry, 2005-2007 */
if 2005<=`year' & `year'<=2007 {
replace anc2p05=anc2p if anc2p~=.
}
#delimit;
lab def anc2p05
1 "Alsatian"
...
;
#delimit cr
lab var anc2p05 "Ancestry detailed-2nd entry"
lab val anc2p05 anc2p05
notes anc2p05: Consistent for 2005-2007
notes anc2p05: ACS: ANC2P
