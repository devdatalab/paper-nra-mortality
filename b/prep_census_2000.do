...
replace edclass = 2 if inlist(educd,61,62,63,64) // note that NO diploma are included in HS completion, and 12th grade is always 12th grade no diploma 
...
/*****************************************/
keep if inlist(gqtype, 1, 2, 3, 4, 6, 7)
...
* save with the dropped states 
preserve 
save $mdata/int/2000_clean, replace
restore


* drop GA, OK, RI, and SD
drop if inlist(stateicp,5,44,53,37)
save $mdata/int/2000_cleandropstates, replace
