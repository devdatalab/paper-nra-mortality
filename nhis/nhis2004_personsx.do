...
local dat_name "$mdata/raw/nhis//2004/personsx.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "$mdata/raw/nhis//nhis2004_personsx"

/* The following line should contain the path to the data dictionary file */

local dct_name "$mdata/raw/nhis//nhis2004_personsx.dct"

infile using "`dct_name'", using("`dat_name'") clear

save $mdata/int/nhis/clean/nhis2004_personsx.dta, replace 
