/****************************************************************/
/* program get_missing_pop : store locals of missing population */
/****************************************************************/
...
import delimited $mortality/ged-count.csv, clear
...
/* Explanation:  which birth cohorts is this feasible for?
...
I want to follow a cohort for 25 years, from 1992 to 2015.
I need their mortality rate in every period.

I can't do a cohort any later than 1967, because I don't observe their
mortality rate in the early years.
- The 1967 cohort is 25 in 1992 and 48 in 2015

I can't do a cohort born any earlier than 1946, because I don't
observe their mortality in 2015 -- they're too old.
- The 1946 cohort is 46 in 1992 and 69 in 2015

I find that the difference gets larger over time. This means later
cohorts are shrinking too quickly.

If I examine mortality at an age category, such as 45-year-olds,
I am slowly moving from the 1946 to the 1967 cohort.
...
foreach bc in 1950 1960 {
  qui {
    ...
    use $mortality/appended_rank_mortgranage, clear
