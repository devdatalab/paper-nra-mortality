...
output_path = os.path.expanduser('~/iec/output/mort_new')
...
br = patches.Rectangle((10, mu_10_40[0]), 30, mu_10_40[1] - mu_10_40[0], facecolor='#66cc00', edgecolor='g', linewidth=2, zorder=0)
ax.add_patch(r)
