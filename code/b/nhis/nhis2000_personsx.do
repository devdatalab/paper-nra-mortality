...
/*------------------------------------------------
  This program reads the 2000 National Health Interview Survey 2000 personsx  Data File
  by Jean Roth Mon Jul  2 15:43:56 EDT 2007
  Please report errors to jroth@nber.org 
  NOTE:  This program is distributed under the GNU GPL.
  See end of this file and http:/www.gnu.org/licenses/ for details.
  Run with do nhis2000_personsx
----------------------------------------------- */
...
local dat_name "$mdata/nhis_data/2000/personsx.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "$mdata/nhis_data/nhis2000_personsx"

/* The following line should contain the path to the data dictionary file */

local dct_name "$mdata/nhis_data/nhis2000_personsx.dct"
...
#delimit cr
*/
save $mdata/nhis_data/clean/nhis2000_personsx,replace
