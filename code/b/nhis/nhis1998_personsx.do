/*------------------------------------------------
  This program reads the 1998 National Health Interview Survey 1998 personsx  Data File
  by Jean Roth Mon Jul  2 15:42:41 EDT 2007
  Please report errors to jroth@nber.org 
  NOTE:  This program is distributed under the GNU GPL.
  See end of this file and http:/www.gnu.org/licenses/ for details.
  Run with do nhis1998_personsx
----------------------------------------------- */
...
local dat_name "$mdata/nhis_data/1998/personsx.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "$mdata/nhis_data/nhis1998_personsx"

/* The following line should contain the path to the data dictionary file */

local dct_name "$mdata/nhis_data/nhis1998_personsx.dct"
...
*/
#delimit cr
save $mdata/nhis_data/clean/nhis1998_personsx,replace
