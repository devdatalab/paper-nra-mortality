...
/*------------------------------------------------
  This program reads the 2003 National Health Interview Survey 2003 personsx  Data File
  by Jean Roth Mon Jul  2 15:45:02 EDT 2007
  Please report errors to jroth@nber.org 
  NOTE:  This program is distributed under the GNU GPL.
  See end of this file and http:/www.gnu.org/licenses/ for details.
  Run with do nhis2003_personsx
----------------------------------------------- */
...
local dat_name "$mdata/nhis_data/2003/personsx.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "$mdata/nhis_data/nhis2003_personsx"

/* The following line should contain the path to the data dictionary file */

local dct_name "$mdata/nhis_data/nhis2003_personsx.dct"
...
;
label values racerpi2 racerpib;
label define racerpib
	01          "White only"                    
	...
	06          "Multiple race"                 
;
label values raceimp2 raceimpb;
label define raceimpb
...
;
label values mracrpi2 mracrpib;
label define mracrpib
	01          "White"                         
...
;
label values mracbpi2 mracbpib;
label define mracbpib
	01          "White"                         
	02          "Black/African American"        
	...
	17          "Multiple race; no primary race selected"
;
label values racreci2 racrecib;
label define racrecib
	1           "White"                         
	2           "Black"                         
	3           "All other race groups*"        
;
label values hiscodi2 hiscodib;
label define hiscodib
	1           "Hispanic"                      
...
*/
#delimit cr
save $mdata/nhis_data/clean/nhis2003_personsx,replace
