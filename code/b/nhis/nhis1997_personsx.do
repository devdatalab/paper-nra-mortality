...
local dat_name "$mdata/nhis_data/1997/personsx.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "$mdata/nhis_data/nhis1997_personsx"

/* The following line should contain the path to the data dictionary file */

local dct_name "$mdata/nhis_data/nhis1997_personsx.dct"
...
*/
#delimit cr
save $mdata/nhis_data/clean/nhis1997_personsx,replace
