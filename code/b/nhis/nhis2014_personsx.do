...
*********************************************************************
 ...
 FILE FROM THE 2014 NHIS Public Use Person ASCII FILE
...
infix
  ...
  str fcohab3      76 -  77      cdcmstat     78 -  78
      ...
      maflg       554 - 554      machmd      555 - 555
      mxchng      556 - 556      medprem     557 - 557
      mdprinc     558 - 558      mapcmd      559 - 559
      maref       560 - 560      single      561 - 561
      sstypea     562 - 562      sstypeb     563 - 563
      sstypec     564 - 564      sstyped     565 - 565
      sstypee     566 - 566      sstypef     567 - 567
      sstypeg     568 - 568      sstypeh     569 - 569
      sstypei     570 - 570      sstypej     571 - 571
      sstypek     572 - 572      sstypel     573 - 573
      private     574 - 574      prflg       575 - 575
      exchange    576 - 576      whonam1     577 - 577
      prpolh1     578 - 578      prcooh1     579 - 579
      prctoh1     580 - 581      prrloh11    582 - 582
      prrloh21    583 - 583      prrloh31    584 - 584
      prrloh41    585 - 585      prcnum1     586 - 587
      cohu191     588 - 589      coh19251    590 - 591
      coho251     592 - 593      plnwrkr1    594 - 595
      plnexch1    596 - 596      exchpr1     597 - 597
      plnpay11    598 - 598      plnpay21    599 - 599
      plnpay31    600 - 600      plnpay41    601 - 601
      plnpay51    602 - 602      plnpay61    603 - 603
      plnpay71    604 - 604      plnpre1     605 - 605
      hicostr1    606 - 610      emppay1     611 - 611
      ecostr1     612 - 616      empcstp1    617 - 619
      plnmgd1     620 - 620      hdhp1       621 - 621
      hsahra1     622 - 622      mgchmd1     623 - 623
      mgprmd1     624 - 624      mgpymd1     625 - 625
      mgpref1     626 - 626      pcpreq1     627 - 627
      prrxcov1    628 - 628      prdncov1    629 - 629
      pxchng      630 - 630      plexchpr    631 - 631
      pstrfprm    632 - 632      pssprinc    633 - 633
      pstdoc      634 - 634      pstcmd      635 - 635
      pstref      636 - 636      whonam2     637 - 637
      prpolh2     638 - 638      prcooh2     639 - 639
      prctoh2     640 - 641      prrloh12    642 - 642
      prrloh22    643 - 643      prrloh32    644 - 644
      prrloh42    645 - 645      prcnum2     646 - 647
      cohu192     648 - 649      coh19252    650 - 651
      coho252     652 - 653      plnwrkr2    654 - 655
      plnexch2    656 - 656      exchpr2     657 - 657
      plnpay12    658 - 658      plnpay22    659 - 659
      plnpay32    660 - 660      plnpay42    661 - 661
      plnpay52    662 - 662      plnpay62    663 - 663
      plnpay72    664 - 664      plnpre2     665 - 665
      hicostr2    666 - 670      emppay2     671 - 671
      ecostr2     672 - 676      empcstp2    677 - 679
      plnmgd2     680 - 680      hdhp2       681 - 681
      hsahra2     682 - 682      mgchmd2     683 - 683
      mgprmd2     684 - 684      mgpymd2     685 - 685
      mgpref2     686 - 686      pcpreq2     687 - 687
      prrxcov2    688 - 688      prdncov2    689 - 689
      prplplus    690 - 690      fcovconf    691 - 691
      schip       692 - 692      chflg       693 - 693
      chxchng     694 - 694      strfprm1    695 - 695
      chprinc     696 - 696      stdoc1      697 - 697
      stpcmd1     698 - 698      stref1      699 - 699
      othpub      700 - 700      opflg       701 - 701
      opxchng     702 - 702      plexchop    703 - 703
      strfprm2    704 - 704      ssprinc     705 - 705
      stdoc2      706 - 706      stpcmd2     707 - 707
      stref2      708 - 708      othgov      709 - 709
      ogflg       710 - 710      ogxchng     711 - 711
      plexchog    712 - 712      strfprm3    713 - 713
      ogprinc     714 - 714      stdoc3      715 - 715
      stpcmd3     716 - 716      stref3      717 - 717
      milcare     718 - 718      milspc1     719 - 719
      milspc2     720 - 720      milspc3     721 - 721
      milspc4     722 - 722      milman      723 - 723
      ihs         724 - 724      hilast      725 - 725
      histop1     726 - 726      histop2     727 - 727
      histop3     728 - 728      histop4     729 - 729
      histop5     730 - 730      histop6     731 - 731
      histop7     732 - 732      histop8     733 - 733
      histop9     734 - 734      histop10    735 - 735
      histop11    736 - 736      histop12    737 - 737
      histop13    738 - 738      histop14    739 - 739
      histop15    740 - 740      hinotyr     741 - 741
      hinotmyr    742 - 743      fhichng     744 - 744
      fhikdba     745 - 745      fhikdbb     746 - 746
      fhikdbc     747 - 747      fhikdbd     748 - 748
      fhikdbe     749 - 749      fhikdbf     750 - 750
      fhikdbg     751 - 751      fhikdbh     752 - 752
      fhikdbi     753 - 753      fhikdbj     754 - 754
      fhikdbk     755 - 755      pwrkbr1     756 - 757
      hcspfyr     758 - 758      medbill     759 - 759
      medbpay     760 - 760      medbnop     761 - 761
      fsa         762 - 762      hikindna    763 - 763
      hikindnb    764 - 764      hikindnc    765 - 765
      hikindnd    766 - 766      hikindne    767 - 767
      hikindnf    768 - 768      hikindng    769 - 769
      hikindnh    770 - 770      hikindni    771 - 771
      hikindnj    772 - 772      hikindnk    773 - 773
      mcareprb    774 - 774      mcaidprb    775 - 775
      sincov      776 - 776

      plborn      777 - 777      regionbr    778 - 779
      geobrth     780 - 780      yrsinus     781 - 781
      citizenp    782 - 782      headst      783 - 783
      headstv1    784 - 784      educ1       785 - 786
      armfver     787 - 787      armfev      788 - 788
      armffc      789 - 789      armftm1p    790 - 790
      armftm2p    791 - 791      armftm3p    792 - 792
      armftm4p    793 - 793      armftm5p    794 - 794
      armftm6p    795 - 795      armftm7p    796 - 796
      armfds2p    797 - 797      doinglwp    798 - 798
      whynowkp    799 - 800      wrkhrs2     801 - 802
      wrkftall    803 - 803      wrklyr1     804 - 804
      wrkmyr      805 - 806      ernyr_p     807 - 808
      hiempof     809 - 809

      fincint     810 - 810      psal        811 - 811
      pseinc      812 - 812      pssrr       813 - 813
      pssrrdb     814 - 814      pssrrd      815 - 815
      ppens       816 - 816      popens      817 - 817
      pssi        818 - 818      pssid       819 - 819
      ptanf       820 - 820      powben      821 - 821
      pintrstr    822 - 822      pdivd       823 - 823
      pchldsp     824 - 824      pincot      825 - 825
      pssapl      826 - 826      psdapl      827 - 827
      tanfmyr     828 - 829      eligpwic    830 - 830
      pwic        831 - 831      wic_flag    832 - 832

      englang     833 - 833

using $mdata/nhis_data/2014/personsx.dat;
...
";
label variable pstcmd   "
Primary care physician for routine care, plan reassigned from public to private
";
label variable pstref   "
Need referral for special care on plan reassigned from public to private";
...
Did - - serve in Desert Shield or Desert Storm between Aug 1990 to Apr 1991?";
...
label define pep451x
   ...
   99999    "99999 Don't know"
;
label define pep452x
   997      "997 Refused"
   998      "998 Not ascertained"
   999      "999 Don’t know"
;
label define pep453x
   1        "1 HMO/IPA"
   2        "2 PPO"
   3        "3 POS"
...
label define pep613x
   ...
   99       "99 Don't know"
;
label define pep616x
   01       "01 1 month or less"
   97       "97 Refused"
   98       "98 Not ascertained"
   99       "99 Don't know"
;
label define pep617x
   01       "01 $01-$4,999"
   02       "02 $5,000-$9,999"
   03       "03 $10,000-$14,999"
   04       "04 $15,000-$19,999"
...
label values maflg     pep403x;   label values machmd    pep404x;
label values mxchng    pep037x;   label values medprem   pep037x;
label values mdprinc   pep037x;   label values mapcmd    pep037x;
label values maref     pep037x;   label values single    pep410x;
...
label values private   pep394x;   label values prflg     pep424x;
label values exchange  pep425x;   label values whonam1   pep426x;
label values prpolh1   pep427x;   label values prcooh1   pep037x;
label values prctoh1   pep387x;   label values prrloh11  pep072x;
label values prrloh21  pep072x;   label values prrloh31  pep072x;
label values prrloh41  pep072x;   label values prcnum1   pep434x;
label values cohu191   pep387x;   label values coh19251  pep387x;
label values coho251   pep387x;   label values plnwrkr1  pep438x;
label values plnexch1  pep037x;   label values exchpr1   pep440x;
...
label values plnpay71  pep072x;   label values plnpre1   pep448x;
label values hicostr1  pep449x;   label values emppay1   pep448x;
label values ecostr1   pep451x;   label values empcstp1  pep452x;
label values plnmgd1   pep453x;   label values hdhp1     pep454x;
label values hsahra1   pep037x;   label values mgchmd1   pep456x;
...
label values pxchng    pep037x;   label values plexchpr  pep440x;
label values pstrfprm  pep037x;   label values pssprinc  pep037x;
label values pstdoc    pep404x;   label values pstcmd    pep037x;
label values pstref    pep037x;   label values whonam2   pep426x;
label values prpolh2   pep427x;   label values prcooh2   pep037x;
label values prctoh2   pep387x;   label values prrloh12  pep072x;
label values prrloh22  pep072x;   label values prrloh32  pep072x;
label values prrloh42  pep072x;   label values prcnum2   pep434x;
label values cohu192   pep387x;   label values coh19252  pep387x;
label values coho252   pep387x;   label values plnwrkr2  pep438x;
label values plnexch2  pep037x;   label values exchpr2   pep440x;
...
label values plnpay72  pep072x;   label values plnpre2   pep448x;
label values hicostr2  pep449x;   label values emppay2   pep448x;
label values ecostr2   pep451x;   label values empcstp2  pep452x;
label values plnmgd2   pep453x;   label values hdhp2     pep498x;
label values hsahra2   pep037x;   label values mgchmd2   pep456x;
label values mgprmd2   pep037x;   label values mgpymd2   pep037x;
label values mgpref2   pep037x;   label values pcpreq2   pep037x;
label values prrxcov2  pep037x;   label values prdncov2  pep037x;
label values prplplus  pep037x;   label values fcovconf  pep508x;
label values schip     pep394x;   label values chflg     pep510x;
label values chxchng   pep037x;   label values strfprm1  pep037x;
label values chprinc   pep037x;   label values stdoc1    pep404x;
label values stpcmd1   pep037x;   label values stref1    pep037x;
label values othpub    pep394x;   label values opflg     pep518x;
label values opxchng   pep037x;   label values plexchop  pep440x;
label values strfprm2  pep037x;   label values ssprinc   pep037x;
label values stdoc2    pep404x;   label values stpcmd2   pep037x;
label values stref2    pep037x;   label values othgov    pep394x;
label values ogflg     pep527x;   label values ogxchng   pep037x;
label values plexchog  pep440x;   label values strfprm3  pep037x;
label values ogprinc   pep037x;   label values stdoc3    pep404x;
label values stpcmd3   pep037x;   label values stref3    pep037x;
label values milcare   pep394x;   label values milspc1   pep072x;
label values milspc2   pep072x;   label values milspc3   pep072x;
label values milspc4   pep072x;   label values milman    pep540x;
label values ihs       pep037x;   label values hilast    pep542x;
label values histop1   pep072x;   label values histop2   pep072x;
label values histop3   pep072x;   label values histop4   pep072x;
label values histop5   pep072x;   label values histop6   pep072x;
label values histop7   pep072x;   label values histop8   pep072x;
label values histop9   pep072x;   label values histop10  pep072x;
label values histop11  pep072x;   label values histop12  pep072x;
label values histop13  pep072x;   label values histop14  pep072x;
label values histop15  pep072x;   label values hinotyr   pep037x;
label values hinotmyr  pep387x;   label values fhichng   pep037x;
label values fhikdba   pep072x;   label values fhikdbb   pep072x;
label values fhikdbc   pep072x;   label values fhikdbd   pep072x;
label values fhikdbe   pep072x;   label values fhikdbf   pep072x;
label values fhikdbg   pep072x;   label values fhikdbh   pep072x;
label values fhikdbi   pep072x;   label values fhikdbj   pep072x;
label values fhikdbk   pep072x;   label values pwrkbr1   pep438x;
label values hcspfyr   pep573x;   label values medbill   pep037x;
label values medbpay   pep037x;   label values medbnop   pep037x;
label values fsa       pep037x;   label values hikindna  pep072x;
label values hikindnb  pep072x;   label values hikindnc  pep072x;
label values hikindnd  pep072x;   label values hikindne  pep072x;
label values hikindnf  pep072x;   label values hikindng  pep072x;
label values hikindnh  pep072x;   label values hikindni  pep072x;
label values hikindnj  pep072x;   label values hikindnk  pep072x;
label values mcareprb  pep037x;   label values mcaidprb  pep037x;
label values sincov    pep037x;

label values plborn    pep037x;   label values regionbr  pep593x;
label values geobrth   pep594x;   label values yrsinus   pep595x;
label values citizenp  pep596x;   label values headst    pep037x;
label values headstv1  pep037x;   label values educ1     pep599x;
label values armfver   pep037x;   label values armfev    pep037x;
label values armffc    pep037x;   label values armftm1p  pep072x;
label values armftm2p  pep072x;   label values armftm3p  pep072x;
label values armftm4p  pep072x;   label values armftm5p  pep072x;
label values armftm6p  pep072x;   label values armftm7p  pep072x;
label values armfds2p  pep037x;   label values doinglwp  pep611x;
label values whynowkp  pep612x;   label values wrkhrs2   pep613x;
label values wrkftall  pep037x;   label values wrklyr1   pep037x;
label values wrkmyr    pep616x;   label values ernyr_p   pep617x;
label values hiempof   pep037x;

label values fincint   pep619x;   label values psal      pep037x;
...
label values tanfmyr   pep387x;   label values eligpwic  pep638x;
label values pwic      pep037x;   label values wic_flag  pep640x;

label values englang   pep641x;
...
save $mdata/nhis_data/clean/nhis2014_personsx, replace;
