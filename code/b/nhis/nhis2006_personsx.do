...
local dat_name "$mdata/nhis_data/2006/personsx.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "$mdata/nhis_data/nhis2006_personsx"

/* The following line should contain the path to the data dictionary file */

local dct_name "$mdata/nhis_data/nhis2006_personsx.dct"

infile using "`dct_name'", using("`dat_name'") clear
save $mdata/nhis_data/clean/nhis2006_personsx.dta, replace
