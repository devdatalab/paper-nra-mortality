...
/*------------------------------------------------
  This program reads the 2001 National Health Interview Survey 2001 personsx  Data File
  by Jean Roth Mon Jul  2 15:42:02 EDT 2007
  Please report errors to jroth@nber.org 
  NOTE:  This program is distributed under the GNU GPL.
  See end of this file and http:/www.gnu.org/licenses/ for details.
  Run with do nhis2001_personsx
----------------------------------------------- */
...
local dat_name "$mdata/nhis_data/2001/personsx.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "$mdata/nhis_data/nhis2001_personsx"

/* The following line should contain the path to the data dictionary file */

local dct_name "$mdata/nhis_data/nhis2001_personsx.dct"
...
#delimit cr
*/
save $mdata/nhis_data/clean/nhis2001_personsx,replace
