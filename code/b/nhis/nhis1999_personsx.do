/*------------------------------------------------
  This program reads the 1999 National Health Interview Survey 1999 personsx  Data File
  by Jean Roth Mon Jul  2 15:43:20 EDT 2007
  Please report errors to jroth@nber.org 
  NOTE:  This program is distributed under the GNU GPL.
  See end of this file and http:/www.gnu.org/licenses/ for details.
  Run with do nhis1999_personsx
----------------------------------------------- */
...
local dat_name "$mdata/nhis_data/1999/personsx.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "$mdata/nhis_data/nhis1999_personsx"

/* The following line should contain the path to the data dictionary file */

local dct_name "$mdata/nhis_data/nhis1999_personsx.dct"
...
;
label values icd9ctni icd9ctni;
label define icd9ctni
...
*/
#delimit cr
save $mdata/nhis_data/clean/nhis1999_personsx,replace
