...
*********************************************************************
 ...
 FILE FROM THE 2008 NHIS Public Use Person ASCII FILE
...
using $mdata/nhis_data/2008/personsx.dat;
...
label variable qcadult  "
FID.580_00.000: Sample Adult data removed for quality reasons";
label variable qcchild  "
FID.590_00.000: Sample Child data removed for quality reasons";
...
label define pep051x
   1        "1 Sample Adult data removed for quality reasons"
;
label define pep052x
   1        "1 Sample Child data removed for quality reasons"
;
...
label define pep439x
   01       "01 HMO"
   02       "02 Non-HMO"
   03       "03 Unknown model type"
   07       "07 Refused"
   08       "08 Not ascertained"
   09       "09 Don't know"
;
...
label values prdncov1  pep037x;   label values hitypen2  pep439x;
...
label values othgov    pep393x;   label values stdoc3    pep402x;
...
save $mdata/nhis_data/clean/nhis2008_personsx, replace;
