...
function ans = get_mort_stats(output_fn, f2_perc_list, type_list, year_list, sex_list, age_list, target_cut_list, ...
  ...
  if nargin == 13
    if strcmp(src_data, 'ybin')
      data = readtable('~/iec/mortality/outfiles/matlab_inputs/appended_rank_mort_3.csv');
      table_mort_means = readtable('~/iec/mortality/outfiles/matlab_inputs/mort_means_3.csv');
    elseif strcmp(src_data, 'ybin_ed3')
      data = readtable('~/iec/mortality/outfiles/matlab_inputs/appended_rank_mort_ed3.csv');
      table_mort_means = readtable('~/iec/mortality/outfiles/matlab_inputs/mort_means_3.csv');
    else    %% implies strcmp(src_data, 'main')
      data = readtable('~/iec/mortality/outfiles/matlab_inputs/appended_rank_mort.csv');
      table_mort_means = readtable('~/iec/mortality/outfiles/matlab_inputs/mort_means.csv');
    end
  end
